...
pub enum Pattern {
    ...
    MatrixRain { columns: Vec<RainColumn> },
}
...
impl<'a> BrailleCanvas<'a> {
    ...
    fn render_matrix_rain(columns: &[RainColumn], area: Rect, buf: &mut Buffer) {
        ...
        const DENSE_GLYPHS: [u8; 16] = [
            0xFF, 0xF7, 0x7F, 0xBF, 0xFE, 0xDB, 0xED, 0xBE, 0x77, 0xEE, 0xD7, 0x7D, 0xBB, 0xEB,
            0xF5, 0xAF,
        ];
        const MID_GLYPHS: [u8; 16] = [
            0x49, 0x92, 0x24, 0x6C, 0x36, 0x5A, 0xA5, 0xC3, 0x1E, 0x78, 0x4B, 0xD2, 0x69, 0x96,
            0x33, 0xCC,
        ];
        const SPARSE_GLYPHS: [u8; 16] = [
            0x01, 0x08, 0x02, 0x10, 0x04, 0x20, 0x40, 0x80, 0x09, 0x12, 0x24, 0x48, 0x03, 0x18,
            0x06, 0x30,
        ];
