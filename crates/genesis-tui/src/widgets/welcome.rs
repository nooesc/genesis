...
pub struct WelcomeWidget {
    info: WelcomeInfo,
    art_lines: Vec<Line<'static>>,
    compact_art_lines: Vec<Line<'static>>,
}
...
impl WelcomeWidget {
    ...
    pub fn new(info: WelcomeInfo, full_art: &[String], compact_art: &[String]) -> Self {
        Self {
            info,
            art_lines: parse_ansi_art(full_art),
            compact_art_lines: parse_ansi_art(compact_art),
        }
    }
    ...
    fn render_full(&self, area: Rect, buf: &mut Buffer) {
        ...
        let art_width = self
            ...
            .max()
            .unwrap_or(0) as u16;
        let art_height = self.art_lines.len() as u16;
        ...
        let art_paragraph = Paragraph::new(self.art_lines.clone());
    ...
    fn render_compact(&self, area: Rect, buf: &mut Buffer) {
        ...
        let art_lines = &self.compact_art_lines;
        ...
        let art_paragraph = Paragraph::new(art_lines.clone());
        art_paragraph.render(art_area, buf);
